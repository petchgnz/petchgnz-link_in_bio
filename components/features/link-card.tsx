...
const LinkCard = ({
  ...
  return (
    <div className=''>
      ...
      >
        <div className='flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-secondary text-foreground group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-75'>
        ...
        <div className='absolute inset-0 -z-10 rounded-xl bg-primary/5 opacity-0 blur-xl transition-opacity duration-200 group-hover:opacity-100' />
      </motion.a>
    </div>
  );
};
